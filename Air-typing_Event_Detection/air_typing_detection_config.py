...
param_scheduler = [
    dict(
        begin=0, by_epoch=False, end=500, start_factor=0.1, type='LinearLR'),
    dict(
        begin=0,
        by_epoch=True,
        end=12,
...
test_dataloader = dict(
    ...
    dataset=dict(
        ann_file='valid.json',
        backend_args=None,
        data_prefix=dict(img='valid_images/'),
        data_root='data',
        metainfo=dict(classes=('tap_point', ), palette=[
            (
                220,
                20,
                60,
